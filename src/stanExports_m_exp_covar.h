...
static constexpr std::array<const char*, 94> locations_array__ =
  ...
  " (in 'string', line 90, column 4 to column 55)",
  " (in 'string', line 91, column 4 to column 55)",
  " (in 'string', line 92, column 4 to column 55)",
  " (in 'string', line 93, column 4 to column 55)",
  ...
  " (in 'string', line 9, column 2 to column 38)",
  ...
  " (in 'string', line 12, column 2 to column 41)",
  ...
  " (in 'string', line 18, column 2 to column 45)",
  " (in 'string', line 19, column 2 to column 45)",
  " (in 'string', line 20, column 2 to column 45)",
  " (in 'string', line 21, column 2 to column 45)",
...
private:
  ...
  Eigen::Matrix<double,-1,-1> X_trt_data__;
  Eigen::Matrix<double,-1,-1> prior_delta_data__;
  ...
  Eigen::Map<Eigen::Matrix<double,-1,-1>> X_trt{nullptr, 0, 0};
  Eigen::Map<Eigen::Matrix<double,-1,-1>> prior_delta{nullptr, 0, 0};
  Eigen::Map<Eigen::Matrix<double,-1,1>> t_grid{nullptr, 0};
public:
  ~model_m_exp_covar() {}
  model_m_exp_covar(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_m_exp_covar_namespace::model_m_exp_covar";
    // suppress unused var warning
    (void) function__;
    ...
    try {
      ...
      stan::math::validate_non_negative_index("S_trt", "nt", nt);
      ...
      current_statement__ = 70;
      S_trt = context__.vals_i("S_trt");
      current_statement__ = 70;
      stan::math::check_greater_or_equal(function__, "S_trt", S_trt, 0);
      current_statement__ = 70;
      stan::math::check_less_or_equal(function__, "S_trt", S_trt, 1);
      ...
      stan::math::validate_non_negative_index("X_trt", "nt", nt);
      current_statement__ = 79;
      stan::math::validate_non_negative_index("X_trt", "p", p);
      current_statement__ = 80;
      context__.validate_dims("data initialization", "X_trt", "double",
        std::vector<size_t>{static_cast<size_t>(nt), static_cast<size_t>(p)});
      X_trt_data__ = Eigen::Matrix<double,-1,-1>::Constant(nt, p,
                       std::numeric_limits<double>::quiet_NaN());
      new (&X_trt)
        Eigen::Map<Eigen::Matrix<double,-1,-1>>(X_trt_data__.data(), nt, p);
      {
        std::vector<local_scalar_t__> X_trt_flat__;
        current_statement__ = 80;
        X_trt_flat__ = context__.vals_r("X_trt");
        current_statement__ = 80;
        pos__ = 1;
        current_statement__ = 80;
        for (int sym1__ = 1; sym1__ <= p; ++sym1__) {
          ...
          for (int sym2__ = 1; sym2__ <= nt; ++sym2__) {
            current_statement__ = 80;
            stan::model::assign(X_trt, X_trt_flat__[(pos__ - 1)],
              "assigning variable X_trt", stan::model::index_uni(sym2__),
              stan::model::index_uni(sym1__));
            current_statement__ = 80;
            pos__ = (pos__ + 1);
          }
      ...
      stan::math::validate_non_negative_index("prior_delta", "p", p);
      current_statement__ = 82;
      context__.validate_dims("data initialization", "prior_delta", "double",
        std::vector<size_t>{static_cast<size_t>(p), static_cast<size_t>(2)});
      prior_delta_data__ = Eigen::Matrix<double,-1,-1>::Constant(p, 2,
                             std::numeric_limits<double>::quiet_NaN());
      new (&prior_delta)
        Eigen::Map<Eigen::Matrix<double,-1,-1>>(prior_delta_data__.data(), p,
        2);
      {
        std::vector<local_scalar_t__> prior_delta_flat__;
        current_statement__ = 82;
        prior_delta_flat__ = context__.vals_r("prior_delta");
        current_statement__ = 82;
        pos__ = 1;
        current_statement__ = 82;
        for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
          ...
          for (int sym2__ = 1; sym2__ <= p; ++sym2__) {
            current_statement__ = 82;
            stan::model::assign(prior_delta, prior_delta_flat__[(pos__ - 1)],
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_m_exp_covar_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      delta = in__.template read<Eigen::Matrix<local_scalar_t__,-1,1>>(p);
                    ...
                    jacobian__>(0, lp__);
      {
        ...
        for (int pp = 1; pp <= p; ++pp) {
          ...
          lp_accum__.add(stan::math::normal_lpdf<propto__>(
                           ...
                           stan::model::rvalue(prior_delta, "prior_delta",
                             stan::model::index_uni(pp),
        ...
        lp_accum__.add(stan::math::bernoulli_logit_lpmf<propto__>(S_trt,
                         stan::math::multiply(X_trt, delta)));
        {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_m_exp_covar_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"delta", "lambda_0N", "lambda_1N",
                "lambda_0T", "lambda_1T"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"delta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(p) + "},\"block\":\"parameters\"},{\"name\":\"lambda_0N\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lambda_1N\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lambda_0T\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lambda_1T\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"hr_N\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"hr_T\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"rmst_N\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"rmst_T\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"S_0N\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(tg) + "},\"block\":\"generated_quantities\"},{\"name\":\"S_1N\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(tg) + "},\"block\":\"generated_quantities\"},{\"name\":\"S_0T\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(tg) + "},\"block\":\"generated_quantities\"},{\"name\":\"S_1T\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(tg) + "},\"block\":\"generated_quantities\"},{\"name\":\"rmst_0N\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"rmst_1N\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"rmst_0T\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"rmst_1T\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((((p + 1) + 1) + 1) + 1);
