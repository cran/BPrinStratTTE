...
#include "stanExports_m_exp_nocovar.h"

RCPP_MODULE(stan_fit4m_exp_nocovar_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_m_exp_nocovar")
